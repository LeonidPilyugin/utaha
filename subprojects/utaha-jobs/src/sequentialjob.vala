...
{
    public class SequentialJobStatus : Utaha.Core.JobStatus
    {
        public Utaha.Core.JobStatus[] statuses { get; private set; }

        public SequentialJobStatus(Utaha.Core.JobStatus[] statuses)
        {
    ...
    public class SequentialJob : Utaha.Core.Job
    {
        private Utaha.Core.Job[] jobs;

        public override bool is_finished()
        {
            return jobs[jobs.length - 1].is_finished();
        }
